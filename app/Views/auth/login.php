    ...
    <div class="auth-split">
        ...
        <div class="auth-left">
            ...
            <div class="auth-roles">
                <div style="font-size: 0.65rem; text-transform: uppercase; letter-spacing: 1px; color: rgba(255, 255, 255, 0.25); margin-bottom: 4px;">
                    Comptes de démonstration
                </div>
                <div class="role-pill">
        ...
        <div class="auth-right">
            ...
            <form action="<?= route_to('auth.authenticate') ?>" method="post">
                <?= csrf_field() ?>
            ...
            <div class="auth-footer">
                ...
                <a href="<?= route_to('auth.register') ?>">S'inscrire</a>
            </div>
        </div>
